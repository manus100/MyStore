...
namespace MyStore.Models
{
    public class SupplierModel
    {
        ...
        [Required]
        [StringLength(40, ErrorMessage = "Company name must be between 10 and 40 characters long!", MinimumLength = 10)]
        [RegularExpression(@"^Supplier .*$", ErrorMessage = "Company name must start with Supplier ")]
